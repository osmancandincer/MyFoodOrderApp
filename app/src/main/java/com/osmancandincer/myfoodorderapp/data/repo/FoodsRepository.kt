package com.osmancandincer.myfoodorderapp.data.repo
...
class FoodsRepository(var foodsDataSource: FoodsDataSource) {
    ...
    suspend fun addToCart(
        ...
        food_name, food_image_name, food_price, food_order_quantity, username
    )
    ...
    suspend fun deleteFoodFromCart(cart_food_id: Int, username: String) =
        foodsDataSource.deleteFoodFromCart(cart_food_id, username)

    suspend fun favoriteFoodsLoad(): List<FavoriteFoods> = foodsDataSource.favoriteFoodsLoad()

    suspend fun addFavoriteFoods(
        food_id: Int, food_name: String, food_image_name: String, food_price: Int
    ) = foodsDataSource.addFavoriteFoods(food_id, food_name, food_image_name, food_price)
